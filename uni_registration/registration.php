...
if (isset($_POST['submit'])) {
  ...
  try {
    ...
    $mail->Username = 'auportal111@gmail.com';                 // SMTP username
    $mail->Password = '123!@#qwe';                           // SMTP password
    $mail->SMTPSecure = 'tls';                            // Enable TLS encryption, `ssl` also accepted
    $mail->Port = 587;                                    // TCP port to connect to
  
    $mail->setFrom('auportal111@gmail.com', 'AU Alumni Portal');
      //Recipients
    //To
    $mail->addAddress('k173931@nu.edu.pk', 'Usama Khan');
                ...
                <tr>
                  <td class="padded">
                   ...
                   <p>University address:  <strong>' . $address . '</strong></p>
                    ...
                    <p style="text-align:center;"><a href="http://localhost/alumni-portal-master/uni_registration/add.php?name=' . $name . '&email=' . $email . '&university=' . $university . '&address=' . $address . '" class="btn">Verify</a></p>
