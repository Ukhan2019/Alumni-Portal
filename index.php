								  	...
								  	<h3>Sign Up</h3>
							            <form action="index.php" method="POST">
							                ...
							                <div class="md-form">
							                    ...
							                    <input placeholder="Ex: Usama" required="" name="fname" type="text" id="materialFormRegisterNameEx" class="form-control">
							                    <label for="">Your First Name</label>
							                </div>
							                <div class="md-form">
							                    <i class="fa fa-user prefix grey-text"></i>
							                    <input placeholder="Ex: Khan" required="" name="lname" type="text" id="materialFormRegisterNameEx" class="form-control">
							                    <label for="">Your Last Name</label>
							                </div>
							                <div class="md-form">
							                    <i class="fas fa-at prefix grey-text"></i>
							                    <input required="" placeholder="Ex : Ukhan12175@gmail.com" name="email" type="email" id="materialFormRegisterEmailEx" class="form-control">
							                    <label for="">Your email</label>
							                </div>
							                <div class="md-form">
							                    <i style="color: #0099CC;" class="fas fa-chalkboard-teacher prefix grey-text"></i>
							                    <input required="" type="text" maxlength="4" placeholder="Ex : 2017" name="batch" id="materialFormRegisterConfirmEx" class="form-control">
							                    <label for="">Batch</label>
							                </div>
							                <div class="md-form">
							                    <i class="fa fa-lock prefix grey-text"></i>
							                    <input required="" type="password" placeholder="*********" id="materialFormRegisterPasswordEx" name="pass" class="form-control">
							                    <label for="">Your password</label>
							                </div>
							                <div class="md-form">
