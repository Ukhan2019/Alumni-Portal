...
<body style="color='white'">
                    ...
                    <nav class="sidebar-nav left-sidebar-menu-pro ">
                        <ul class="metismenu" id="menu1">
                            ...
                            <li <?php if ($_SESSION['ssrole']== 'Alumni'){ echo "style='visibility:hidden;'";} ?>>
                                <a class="has-arrow" href="requests.php" aria-expanded="false"><span class="educate-icon educate-student icon-wrap"></span>
        ...
        <div class="header-advance-area">
            ...
            <div class="breadcome-area">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <a style="background-color: #3a6df0; /* Green */
  border: none;
  border-radius:5px;
  margin:10px;
  float:right;
  ...
  font-size: 16px;"  href="logout.php"><span class="edu-icon edu-locked author-log-ic"></span>LogOut</a>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="single-product-text">
                                ...
                                elseif ($_SESSION['ssrole']== 'Admin') {
                                    ...
                                    // }
                                     ...
                                     echo "src='img/product/asd.jpg'";
                                 }
                                 else{
                                    echo "src='img/contact/aisar.jpg'";
                                 } ?> alt="">
